...
class Rojo04TestGitStatusRenamedFilesAsStandaloneRequest(NexusGitFunctionalTest.NexusGitFunctionalTest):
    ...
    def runTest(self):
        ...
        response = self.sendGETRequest("/getgitstatus")
        self.assertEquals(response,"[\"Current branch:\",\"master\",\"Changes to be committed:\",\"New file: file2.txt\",\"New file: file3.txt\",\"Renamed: file1.txt -> file4.txt\",\"New file: rojo.json\"]")